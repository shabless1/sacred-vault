...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Tags come back as comma-space separated string e.g. "Login with Shop, sacred-vault-member, newsletter"
    const tagsRaw = Array.isArray(customer.tags) ? customer.tags.join(', ') : (customer.tags || '');
